...
|------------|---------|-----------|----------|
| **DPDK virtio-user** | quinn-proto + DPDK 25.11 | **4.97 Gbps** | Experimental |
...
Kernel WireGuard reference: 1.53 Gbps (same hardware, same NIC). DPDK is **3.2x faster** than kernel WireGuard. All benchmarks on AMD Ryzen 9700X (AES-NI, AVX-512), Proxmox KVM VM, virtio NIC, host CPU passthrough. Raw NIC: 26.8 Gbps.
